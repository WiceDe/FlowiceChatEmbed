    ...
    return (
        <>
            <div ref={botContainer} class={'relative flex w-full h-full text-base overflow-hidden bg-cover bg-center flex-col items-center chatbot-container ' + props.class}>
                <Header usageTier={props.usageTier} headerText={props.headerText} headerImageUrl={props.headerImageUrl} headerBackgroundColor={props.headerBackgroundColor} headerTextColor={props.headerTextColor} headerContactLink={props.headerContactLink} botContainer={botContainer} />
